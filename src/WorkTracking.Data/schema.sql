...
CREATE TABLE IF NOT EXISTS client (
    ...
    invoice_cap_behavior TEXT,
    invoice_frequency_days INTEGER,
    last_invoice_date TEXT,
    next_invoice_due_date TEXT,
...
CREATE TABLE IF NOT EXISTS client_work_category (
...
CREATE INDEX IF NOT EXISTS idx_work_entry_client_date ON work_entry (client_id, date);
CREATE INDEX IF NOT EXISTS idx_work_entry_invoice ON work_entry (invoice_id);
CREATE INDEX IF NOT EXISTS idx_invoice_client_date ON invoice (client_id, invoice_date);
CREATE INDEX IF NOT EXISTS idx_work_entry_invoiced_flag ON work_entry (invoiced_flag);
